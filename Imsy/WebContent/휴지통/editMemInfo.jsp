            ...
            <table border="0" class="tbl_model">
                    ...
                    <td>
                        <div class="tdcell">
                            <p class="contxt_webctrl nickname">
                                <input type="password" name="pw" id="pw" value="" style="width:260px; height: 25px;" >
                ...
                <tr>
                    ...
                    <td>
                        <div class="tdcell">
                            <p class="contxt_webctrl nickname">
                                <input type="password" name="newpw" id="newpw" value="" style="width:260px; height: 25px;" >
                                <!-- Enter 입력으로 submit이 되는걸 방지하기 위한 Input -->
                                <input type="text" style="display: none;">
                            </p>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="tdcell">
                            <p class="contxt_webctrl nickname">
                                <input type="password" name="newpwck" id="newpwck" value="" style="width:260px; height: 25px;" >
                                <!-- Enter 입력으로 submit이 되는걸 방지하기 위한 Input -->
                                <input type="text" style="display: none;">
                            </p>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="tdcell">
                            <span class="nickname"><h4>관심분야</h4>
                            	<input type="radio" id="inter_Y" name="intershow"><label for="inter_Y">공개</label>
                            	<input type="radio" id="inter_N" name="intershow"><label for="inter_N">비공개</label>
                                <!-- Enter 입력으로 submit이 되는걸 방지하기 위한 Input -->
                                <input type="text" style="display: none;">
                            </span>
                            <span class="nickname"><h4>생년월일</h4>
                            	<input type="radio" id="birth_Y" name="birthshow"><label for="birth_Y">공개</label>
                            	<input type="radio" id="birth_N" name="birthshow"><label for="birth_N">비공개</label>
                                <!-- Enter 입력으로 submit이 되는걸 방지하기 위한 Input -->
                                <input type="text" style="display: none;">
                            </span>
                            <span class="nickname"><h4>성별</h4>
                            	<input type="radio" id="gen_Y" name="genshow"><label for="gen_Y">공개</label>
                            	<input type="radio" id="gen_N" name="genshow"><label for="gen_N">비공개</label>
                                <!-- Enter 입력으로 submit이 되는걸 방지하기 위한 Input -->
                                <input type="text" style="display: none;">
                            </span>
                        </div>
