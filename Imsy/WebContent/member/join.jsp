				...
				$.ajax({
					...
					success: function(data) {
						...
						if(result == 0){
							...
							// 아이디가 사용 불가능한 경우
							alert('사용할 수 없는 아이디입니다. 다른 아이디를 작성해주세요');
							$('#id').focus();
						}
					},
					error: function() {
            ...
            <div class="join_content">
                ...
                <div class="row_group">
                    <div class="join_row">
                        ...
                        <span class="ps_box int_id" style="padding-right: 0px;">
							<!-- <input type="text" id="id" name="id" class="int" title="ID" maxlength="20"> -->
							<input type="text" id="id" name="id" title="ID" maxlength="20" style="width: 330px; height: 29px;">
                    		<button type="button" id="idck" style="background-color: black; color: white; width: 80px; font-size: 20px; font-weight: 700; text-align: center; margin-left: 15px;"><span>중복확인</span></button>
